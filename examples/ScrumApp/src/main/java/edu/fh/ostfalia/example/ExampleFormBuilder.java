...
public class ExampleFormBuilder {
	public static void main(String[] args) throws Exception {
		...
		FormLayout layout = new FormLayout("right:p, 3dlu, p:grow", "p, 3dlu, p, 3dlu, p, 3dlu, fill:p:grow, 3dlu, p, 1dlu, p, 8dlu, p");
...
//		JPanel panel = new FormDebugPanel();
		...
		builder.addLabel("Geändert am " + DateFormat.getDateTimeInstance().format(new Date()), cc.xy(3, 11, "right,d"));
		
		builder.add(ButtonBarFactory.buildHelpOKCancelBar(new JButton("Hilfe"), new JButton("Speichern"), new JButton("Abbrechen")), cc.xyw(1, 13, 3));
